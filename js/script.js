...
const timer = setInterval(() => {
  ...
  if (distance < 0) {
    ...
    document.querySelector(".countdown").innerHTML =
      "<strong>🎉 ពិធីបានចាប់ផ្តើម 🎉</strong>";
    return;
  }
    ...
    special: {
      ...
      click: {
        ...
        trigger: function (a) {
          var b = this || a;
          return (
            gb.test(b.type) && b.click && f(b, "input") && C(b, "click"),
            !0
          );
        },
        _default: function (a) {
